...
// Application ID
let index = 646534316; // Make sure you change it to yours.

let myaccount = algosdk.mnemonicToSecretKey("adapt nurse fashion employ shrug argue shallow congress hill net lamp pen always trend tape comic retire maximum thrive dolphin crater panel mystery ability boring");
...
(async () => {
    try {
        ...
        console.log("Signed transaction with txID:", txId2);
